...
public class ControlPanel {
	...
	private static JLabel status = new JLabel("状态：准备就绪");
	...
	public void init()
	{
		...
		textField1.addFocusListener(new JTextFieldHintListener("班级", textField1));
		...
		textField2.addFocusListener(new JTextFieldHintListener("学号", textField2));
